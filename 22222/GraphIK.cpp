...
GraphIK::GraphIK(QWidget *parent) :
    QDialog(parent)
{
    //
    // Set up the GUI
    ...
    setWindowTitle("Измерительные каналы");
...
//
void GraphIK::onMouseUsageChanged(int mouseUsage)
{
...
//
void GraphIK::onUpdatePeriodChanged(QString text)
{
...
//
void GraphIK::onDataTimer(double ik1,double ik2,double ik3,double ik4,double tau)
{
        ...
        m_timeStamps[m_currentIndex] = tau;
        m_dataSeriesA[m_currentIndex] = ik1;
        m_dataSeriesB[m_currentIndex] = ik2;
        m_dataSeriesC[m_currentIndex] = ik3;
        m_dataSeriesD[m_currentIndex] = ik4;
        ++m_currentIndex;
   ...
   m_ValueD->setText(QString::number(m_dataSeriesD[m_currentIndex - 1], 'f', 2));
...
//
void GraphIK::onChartUpdateTimer()
{
    if (m_currentIndex > 0)
    {
        //
...
//
void GraphIK::onViewPortChanged()
{
...
//
void GraphIK::onHScrollBarChanged(int value)
{
...
//
void GraphIK::updateControls(QChartViewer *viewer)
{
...
// Draw chart
//
void GraphIK::drawChart(QChartViewer *viewer)
{
    ...
    c->addTitle("    Измерительные каналы", "arial.ttf", 18);
    ...
    c->yAxis()->setTitle("Угловая скорость, градус/с", "arialbd.ttf", 12);
    ...
    layer->addDataSet(viewPortDataSeriesA, 0xff0000, "IK1");
    layer->addDataSet(viewPortDataSeriesB, 0x00cc00, "IK2");
    layer->addDataSet(viewPortDataSeriesC, 0x0000ff, "IK3");
    layer->addDataSet(viewPortDataSeriesD, 0xff00ff, "IK4");
...
//
void GraphIK::onMouseMovePlotArea(QMouseEvent *)
{
...
//
void GraphIK::trackLineLabel(XYChart *c, int mouseX)
{
