...
GraphKA::GraphKA(QWidget *parent) :
    QDialog(parent)
{
    //
    // Set up the GUI
    ...
    setWindowTitle("Угловая скорость КА");
...
//
void GraphKA::onMouseUsageChanged(int mouseUsage)
{
...
//
void GraphKA::onUpdatePeriodChanged(QString text)
{
...
//
void GraphKA::onDataTimer(double x,double y,double z,double tau)
{
...
//
void GraphKA::onChartUpdateTimer()
{
    if (m_currentIndex > 0)
    {
        //
...
//
void GraphKA::onViewPortChanged()
{
...
//
void GraphKA::onHScrollBarChanged(int value)
{
...
//
void GraphKA::updateControls(QChartViewer *viewer)
{
...
// Draw chart
//
void GraphKA::drawChart(QChartViewer *viewer)
{
    ...
    c->addTitle("    Угловая скорость в системе КА", "arial.ttf", 18);
...
//
void GraphKA::onMouseMovePlotArea(QMouseEvent *)
{
...
//
void GraphKA::trackLineLabel(XYChart *c, int mouseX)
{
